...
/**
 * Methods supporting a list of Steamid records.
 */
class SteamidModelSteamids extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        parent::populateState('a.personaname', 'asc');
    }
    ...
    protected function getListQuery() {
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.personaname LIKE '.$search.'  OR  a.realname LIKE '.$search.' )');
            }
        }
